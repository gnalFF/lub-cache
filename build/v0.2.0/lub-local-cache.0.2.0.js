...
angular.module("lub-storage", [])
    ...
    .factory("lubStorageFailover", function (lubStorageKeysHelper, lubStorageRandomHelper) {
    ...
    .factory("lubStorage", function ($window, lubStorageFailover, lubStorageKeysHelper) {
        var caches = {};
